    ...
    <div className="space-y-6 animate-pulse select-none">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-3">
          <div className="h-9 w-36 bg-slate-100 rounded-xl"></div>
          <div className="h-9 w-44 bg-slate-200 rounded-xl"></div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
        <div className="lg:col-span-8 bg-white rounded-2xl border border-slate-100 p-5 space-y-4 h-96">
          <div className="h-10 bg-slate-50 rounded-xl"></div>
          <div className="h-64 bg-slate-50 rounded-xl"></div>
        </div>
        <div className="lg:col-span-4 space-y-5">
          <div className="h-48 bg-white rounded-2xl border border-slate-100 p-5"></div>
          <div className="h-40 bg-white rounded-2xl border border-slate-100 p-5"></div>
        </div>
      </div>
    </div>
  )
